...
<div class="content">
  ...
  <form action="" class="form">
    ...
    <div class="box">
      <span>验证码</span><input type="password" placeholder=" 请输入验证码"><span class="telreg">获取验证码</span>
    </div>
    <div class="text">
      <input type="radio"/><span>我已同意</span><a href="##">《浣衣阁用户注册协议》</a>
    </div>
    <div class="sub">
    ...
    <div class="foot">
      ...
      <router-link to="/find">密码找回</router-link>
